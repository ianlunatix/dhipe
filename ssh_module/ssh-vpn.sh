...
REPO="https://raw.githubusercontent.com/ianlunatix/dhipe/main/"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/ianlunatix/dhipe/ssh_module/main/haproxy.cfg"
